...
import kamileNails from "../images/kamile-business.jpg";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                Especialista em nail art personalizada, criando designs únicos
                que refletem sua personalidade. Mais de 2 anos de experiência
                transformando unhas em verdadeiras obras de arte.
              </p>
            </div>
          ...
          <div className="relative">
            ...
            {/* Floating card */}
            <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl shadow-xl p-6 border border-pink-100 z-50">
              <div className="flex items-center space-x-3">
                <div className="flex -space-x-2">
                  {[...Array(3)].map((_, i) => (
                    <div
                      key={i}
                      className="w-8 h-8 rounded-full bg-gradient-to-r from-pink-400 to-rose-400 border-2 border-white"
                    ></div>
                  ))}
                </div>
                <div>
